...
// This prepares the input for the neural network from FEN
// First 256 bits represent the 64 squares (4 bits each)
// The rest represent state of the game such as en passant, etc
